...
public class NativizedAssets : ModuleRules
{
	public NativizedAssets(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[] { "CoreUObject", "MagicLeapARPin", "NavigationSystem", "InputCore", "OnlineSubsystemUtils", "SlateCore", "UMG", "ClothingSystemRuntimeNv", "AIModule", "PhysicsCore", "AnimGraphRuntime", "Landscape", "StaticMeshDescription", "MeshDescription", "AudioExtensions", "AudioPlatformConfiguration", "GameplayTasks", "GameplayTags", "ClothingSystemRuntimeInterface", "PropertyAccess", "PropertyPath", "MovieScene", "Slate", "AudioMixer" });
