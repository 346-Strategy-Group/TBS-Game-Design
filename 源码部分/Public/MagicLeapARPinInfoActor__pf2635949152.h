...
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="Right"))
	UStaticMeshComponent* bpv__Right__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="Forward"))
	UStaticMeshComponent* bpv__Forward__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="Up"))
	UStaticMeshComponent* bpv__Up__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="ValidRadiusVisualizer"))
	USphereComponent* bpv__ValidRadiusVisualizer__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="AxisRoot"))
	USceneComponent* bpv__AxisRoot__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="VisualizerRoot"))
	USceneComponent* bpv__VisualizerRoot__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="TypeValue"))
	UTextRenderComponent* bpv__TypeValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="TransErrValue"))
	UTextRenderComponent* bpv__TransErrValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="RotErrValue"))
	UTextRenderComponent* bpv__RotErrValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="ConfidenceValue"))
	UTextRenderComponent* bpv__ConfidenceValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="TransErrLabel"))
	UTextRenderComponent* bpv__TransErrLabel__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="RotErrLabel"))
	UTextRenderComponent* bpv__RotErrLabel__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="ConfidenceLabel"))
	UTextRenderComponent* bpv__ConfidenceLabel__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="PinIDValue"))
	UTextRenderComponent* bpv__PinIDValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="InfoRoot"))
	USceneComponent* bpv__InfoRoot__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="Root"))
	USceneComponent* bpv__Root__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Rotation Smooth Speed", Category="默认", MultiLine="true", OverrideNativeName="RotationSmoothSpeed"))
