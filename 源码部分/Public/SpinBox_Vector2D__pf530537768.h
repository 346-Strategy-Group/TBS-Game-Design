...
class USpinBox;
class UTextBlock;
#include "SpinBox_Vector2D__pf530537768.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/DebugMenu/Widgets/SpinBox_Vector2D.SpinBox_Vector2D_C", OverrideNativeName="SpinBox_Vector2D_C"))
class USpinBox_Vector2D_C__pf530537768 : public UUserWidget
{
public:
	GENERATED_BODY()
	UDELEGATE(meta=(OverrideNativeName="on_Value_Changed__DelegateSignature"))
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(Fon_Value_Changed__pf__SpinBox_Vector2D_C__pf__MulticastDelegate , FVector2D , bpp__Value__pf);
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="SpinBox_Value_X", Category="SpinBox_Vector2D", OverrideNativeName="SpinBox_Value_X"))
	USpinBox* bpv__SpinBox_Value_X__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="SpinBox_Value_Y", Category="SpinBox_Vector2D", OverrideNativeName="SpinBox_Value_Y"))
	USpinBox* bpv__SpinBox_Value_Y__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="TextBlock_Value", Category="SpinBox_Vector2D", OverrideNativeName="TextBlock_Value"))
	...
	Fon_Value_Changed__pf__SpinBox_Vector2D_C__pf__MulticastDelegate bpv__on_Value_Changed__pf;
	...
	USpinBox_Vector2D_C__pf530537768(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_0(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_SpinBox_Vector2D_1"))
	void bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_1(int32 bpp__EntryPoint__pf);
	...
	virtual void bpf__Set_Value__pf(FVector2D bpp__NewValue__pf);
public:
