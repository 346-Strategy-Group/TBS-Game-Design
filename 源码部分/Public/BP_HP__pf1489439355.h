...
#include "BP_HP__pf1489439355.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/UI/BP_HP.BP_HP_C", OverrideNativeName="BP_HP_C"))
class UBP_HP_C__pf1489439355 : public UUserWidget
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_0", Category="BP_HP", OverrideNativeName="Image_0"))
	...
	float bpv__hp__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Hplerp", Category="默认", MultiLine="true", OverrideNativeName="hplerp"))
	float bpv__hplerp__pf;
	...
	UBP_HP_C__pf1489439355(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_HP__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_HP__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_HP__pf_2(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="initUI"))
	virtual void bpf__initUI__pf(Achesscharacter_C__pf772598429* bpp__pawn__pf);
public:
