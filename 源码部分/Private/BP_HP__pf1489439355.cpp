...
UBP_HP_C__pf1489439355::UBP_HP_C__pf1489439355(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Image_0__pf = nullptr;
	bpv__Pawn__pf = nullptr;
	bpv__hp__pf = 0.000000f;
	bpv__hplerp__pf = 0.000000f;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UBP_HP_C__pf1489439355::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBP_HP_C__pf1489439355::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__3->LayoutData.Offsets.Left = -52.960938f;
	__Local__3->LayoutData.Offsets.Top = -60.540527f;
	...
	__Local__5 = CastChecked<UObject>(CastChecked<UDynamicClass>(UBP_HP_C__pf1489439355::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
PRAGMA_ENABLE_OPTIMIZATION
void UBP_HP_C__pf1489439355::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__6;
	SlotNames.Append(__Local__6);
}
void UBP_HP_C__pf1489439355::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__7;
	TArray<FDelegateRuntimeBinding>  __Local__8;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UBP_HP_C__pf1489439355::StaticClass())->MiscConvertedSubobjects[0]), __Local__7, __Local__8);
}
void UBP_HP_C__pf1489439355::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UBP_HP_C__pf1489439355::bpf__ExecuteUbergraph_BP_HP__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__Pawn__pf))
	{
		bpv__Pawn__pf->bpv__health__pf = ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__health__pf) : (__Local__9));
	}
	// optimized KCST_UnconditionalGoto
	UNetPushModelHelpers::MarkPropertyDirtyFromRepIndex(bpv__Pawn__pf, 23, FName(TEXT("health")));
	...
	bpfv__CallFunc_Divide_FloatFloat_ReturnValue_1__pf = FCustomThunkTemplates::Divide_FloatFloat(((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__health__pf) : (__Local__10)), ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__healthmax__pf) : (__Local__11)));
...
void UBP_HP_C__pf1489439355::bpf__ExecuteUbergraph_BP_HP__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpv__hp__pf = ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__health__pf) : (__Local__12));
	// optimized KCST_UnconditionalGoto
	bpv__hplerp__pf = bpv__hp__pf;
	if(::IsValid(bpv__Image_0__pf))
	{
		bpfv__CallFunc_GetDynamicMaterial_ReturnValue__pf = bpv__Image_0__pf->UImage::GetDynamicMaterial();
	}
	float  __Local__13 = 0.000000;
	bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(bpv__hplerp__pf, ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__healthmax__pf) : (__Local__13)));
	if(::IsValid(bpfv__CallFunc_GetDynamicMaterial_ReturnValue__pf))
	{
		bpfv__CallFunc_GetDynamicMaterial_ReturnValue__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("Percentage")), bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf);
	}
	return; // KCST_GotoReturn
}
void UBP_HP_C__pf1489439355::bpf__ExecuteUbergraph_BP_HP__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UBP_HP_C__pf1489439355::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b0l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b0l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_BP_HP__pf_0(15);
}
void UBP_HP_C__pf1489439355::bpf__1__pf()
{
	bpf__ExecuteUbergraph_BP_HP__pf_1(12);
}
void UBP_HP_C__pf1489439355::bpf__initUI__pf(Achesscharacter_C__pf772598429* bpp__pawn__pf)
{
	b0l__K2Node_CustomEvent_pawn__pf = bpp__pawn__pf;
	bpf__ExecuteUbergraph_BP_HP__pf_2(10);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBP_HP_C__pf1489439355::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UBP_HP_C__pf1489439355::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UBP_HP_C__pf1489439355
{
	FRegisterHelper__UBP_HP_C__pf1489439355()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/UI/BP_HP"), &UBP_HP_C__pf1489439355::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UBP_HP_C__pf1489439355 Instance;
};
FRegisterHelper__UBP_HP_C__pf1489439355 FRegisterHelper__UBP_HP_C__pf1489439355::Instance;
