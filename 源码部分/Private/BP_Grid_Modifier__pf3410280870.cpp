...
#include "BFL_GridShape__pf3764965557.h"
...
ABP_Grid_Modifier_C__pf3410280870::ABP_Grid_Modifier_C__pf3410280870(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Grid_Modifier_C__pf3410280870::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Grid_Modifier_C__pf3410280870::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), true, 0));
	bpv__Shape__pf = E__E_Grid_Shape__pf::NewEnumerator2;
	bpv__Type__pf = E__E_TileType__pf::NewEnumerator2;
...
void ABP_Grid_Modifier_C__pf3410280870::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Grid_Modifier_C__pf3410280870::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UBFL_GridShape_C__pf3764965557::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Grid_Modifier_C__pf3410280870::bpf__UserConstructionScript__pf()
{
	E__E_TileType__pf bpfv_____byte_Variable__pf{};
	...
	FS_Grid_Shape_Data__pf3764965557 bpfv__CallFunc_Get_ShapeData_Data__pf{};
	...
	UBFL_GridShape_C__pf3764965557::bpf__Get_ShapeData__pf(bpv__Shape__pf, this, /*out*/ bpfv__CallFunc_Get_ShapeData_Data__pf);
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__StaticMesh__pf->SetStaticMesh(bpfv__CallFunc_Get_ShapeData_Data__pf.bpv__Mesh_7_BF5086784E7FB4DEF5AA1483C613D5EB__pf);
	}
	UBFL_GridShape_C__pf3764965557::bpf__Get_ShapeData__pf(bpv__Shape__pf, this, /*out*/ bpfv__CallFunc_Get_ShapeData_Data__pf);
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpv__StaticMesh__pf->SetMaterial(0, bpfv__CallFunc_Get_ShapeData_Data__pf.bpv__FlatMetiral_17_AE20C76D40F9FF6D19F94587099F0F46__pf);
	}
	bpfv_____struct_Variable__pf = FLinearColor(1.000000,0.000000,0.000000,1.000000);
	bpfv_____struct_Variable_1__pf = FLinearColor(1.000000,1.000000,1.000000,1.000000);
	bpfv_____struct_Variable_2__pf = FLinearColor(0.000000,0.000000,0.000000,1.000000);
	bpfv_____byte_Variable__pf = bpv__Type__pf;
	bpfv__CallFunc_Conv_LinearColorToVector_ReturnValue__pf = UKismetMathLibrary::Conv_LinearColorToVector(TSwitchValue<E__E_TileType__pf , FLinearColor >(bpfv_____byte_Variable__pf, bpfv__K2Node_Select_Default__pf, 3, TSwitchPair<E__E_TileType__pf , FLinearColor >(E__E_TileType__pf::NewEnumerator0, bpfv_____struct_Variable_2__pf), TSwitchPair<E__E_TileType__pf , FLinearColor >(E__E_TileType__pf::NewEnumerator1, bpfv_____struct_Variable_1__pf), TSwitchPair<E__E_TileType__pf , FLinearColor >(E__E_TileType__pf::NewEnumerator2, bpfv_____struct_Variable__pf)));
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpv__StaticMesh__pf->UMeshComponent::SetVectorParameterValueOnMaterials(FName(TEXT("Color")), bpfv__CallFunc_Conv_LinearColorToVector_ReturnValue__pf);
	}
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpv__StaticMesh__pf->UMeshComponent::SetScalarParameterValueOnMaterials(FName(TEXT("IsFilled")), 1.000000);
	}
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpv__StaticMesh__pf->SetCollisionResponseToChannel(ECollisionChannel::ECC_GameTraceChannel1, ECollisionResponse::ECR_Overlap);
	}
	SetActorHiddenInGame(true);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Grid_Modifier_C__pf3410280870::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Grid_Modifier_C__pf3410280870::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{66, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Core/Grid/Grid_Shapes/BFL_GridShape.BFL_GridShape_C 
		...
		{2, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedEnum /Game/Blueprints/Core/Grid/Utilities/E_TileType.E_TileType 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Grid_Modifier_C__pf3410280870
{
	FRegisterHelper__ABP_Grid_Modifier_C__pf3410280870()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Core/Grid/BP_Grid_Modifier"), &ABP_Grid_Modifier_C__pf3410280870::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Grid_Modifier_C__pf3410280870 Instance;
};
FRegisterHelper__ABP_Grid_Modifier_C__pf3410280870 FRegisterHelper__ABP_Grid_Modifier_C__pf3410280870::Instance;
