...
#include "BP_Hero__pf1964576356.h"
...
ABP_Hero_C__pf1964576356::ABP_Hero_C__pf1964576356(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__2 = (*(AccessPrivateProperty<FRotator >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__2 = FRotator(0.000000, -90.000183, 0.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__SkeletalMesh__pf), false, 0));
	bpv__TestAnimIndex__pf = E__E_HeroAnimationWarrior__pf::NewEnumerator0;
...
void ABP_Hero_C__pf1964576356::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Hero_C__pf1964576356::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Hero_C__pf1964576356::bpf__ExecuteUbergraph_BP_Hero__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		IBPI_HeroAnimation_C::Execute_bpf__SetHeroAnimationStates__pf(b0l__K2Node_DynamicCast_AsBPI_Hero_Animation__pf.GetObject() , bpv__TestAnimIndex__pf);
	}
	return; // KCST_GotoReturn
}
void ABP_Hero_C__pf1964576356::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_Hero__pf_0(1);
}
void ABP_Hero_C__pf1964576356::bpf__UserConstructionScript__pf()
{
	...
	bpfv_____object_Variable__pf = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_Hero_C__pf1964576356::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	if(::IsValid(bpv__SkeletalMesh__pf))
	{
		UClass*  __Local__4 = bpfv_____class_Variable__pf;
		bpv__SkeletalMesh__pf->SetAnimClass(TSwitchValue<E__E_HeroType__pf , UClass* >(bpfv_____byte_Variable__pf, bpfv__K2Node_Select_Default__pf, 1, TSwitchPair<E__E_HeroType__pf , UClass* >(E__E_HeroType__pf::NewEnumerator0, __Local__4)));
	}
}
void ABP_Hero_C__pf1964576356::bpf__MoveByGrid__pf(ABP_Grid_C__pf3410280870* bpp__Grid__pf, FIntPoint bpp__src__pf, FIntPoint bpp__dst__pf)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Hero_C__pf1964576356::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Hero_C__pf1964576356::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Hero_C__pf1964576356
{
	FRegisterHelper__ABP_Hero_C__pf1964576356()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Core/Heros/BP_Hero"), &ABP_Hero_C__pf1964576356::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Hero_C__pf1964576356 Instance;
};
FRegisterHelper__ABP_Hero_C__pf1964576356 FRegisterHelper__ABP_Hero_C__pf1964576356::Instance;
