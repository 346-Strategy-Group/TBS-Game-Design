...
Umana_C__pf1489439355::Umana_C__pf1489439355(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Image_0__pf = nullptr;
	bpv__Pawn__pf = nullptr;
	bpv__hp__pf = 3.000000f;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void Umana_C__pf1489439355::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void Umana_C__pf1489439355::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__3->LayoutData.Offsets.Left = -48.960938f;
	__Local__3->LayoutData.Offsets.Top = -24.540527f;
	...
	__Local__5 = CastChecked<UObject>(CastChecked<UDynamicClass>(Umana_C__pf1489439355::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
PRAGMA_ENABLE_OPTIMIZATION
void Umana_C__pf1489439355::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__6;
	SlotNames.Append(__Local__6);
}
void Umana_C__pf1489439355::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__7;
	TArray<FDelegateRuntimeBinding>  __Local__8;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(Umana_C__pf1489439355::StaticClass())->MiscConvertedSubobjects[0]), __Local__7, __Local__8);
}
void Umana_C__pf1489439355::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void Umana_C__pf1489439355::bpf__ExecuteUbergraph_mana__pf_0(int32 bpp__EntryPoint__pf)
{
	float bpfv__CallFunc_Divide_FloatFloat_ReturnValue_1__pf{};
	float bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_FMin_ReturnValue_1__pf{};
	UMaterialInstanceDynamic* bpfv__CallFunc_GetDynamicMaterial_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 9);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__Pawn__pf))
	{
		bpv__Pawn__pf->AActor::FlushNetDormancy();
	}
	float  __Local__9 = 0.000000;
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__mana__pf) : (__Local__9)), 0.050000);
	float  __Local__10 = 0.000000;
	bpfv__CallFunc_FMin_ReturnValue_1__pf = UKismetMathLibrary::FMin(bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf, ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__manamax__pf) : (__Local__10)));
	if(::IsValid(bpv__Pawn__pf))
	{
		bpv__Pawn__pf->bpv__mana__pf = bpfv__CallFunc_FMin_ReturnValue_1__pf;
	}
	UNetPushModelHelpers::MarkPropertyDirtyFromRepIndex(bpv__Pawn__pf, 26, FName(TEXT("mana")));
	if(::IsValid(bpv__Image_0__pf))
	{
		bpfv__CallFunc_GetDynamicMaterial_ReturnValue_1__pf = bpv__Image_0__pf->UImage::GetDynamicMaterial();
	}
	float  __Local__11 = 0.000000;
	float  __Local__12 = 0.000000;
	bpfv__CallFunc_Divide_FloatFloat_ReturnValue_1__pf = FCustomThunkTemplates::Divide_FloatFloat(((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__mana__pf) : (__Local__11)), ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__manamax__pf) : (__Local__12)));
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(1.000000, bpfv__CallFunc_Divide_FloatFloat_ReturnValue_1__pf);
	if(::IsValid(bpfv__CallFunc_GetDynamicMaterial_ReturnValue_1__pf))
	{
		bpfv__CallFunc_GetDynamicMaterial_ReturnValue_1__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("Percentage")), bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf);
	}
	return; // KCST_GotoReturn
}
void Umana_C__pf1489439355::bpf__ExecuteUbergraph_mana__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__Pawn__pf);
	...
	bpfv__CallFunc_FMin_ReturnValue__pf = UKismetMathLibrary::FMin(((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__mana__pf) : (__Local__13)), ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__manamax__pf) : (__Local__14)));
	float  __Local__15 = 0.000000;
	bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(bpfv__CallFunc_FMin_ReturnValue__pf, ((::IsValid(bpv__Pawn__pf)) ? (bpv__Pawn__pf->bpv__manamax__pf) : (__Local__15)));
	bpv__hp__pf = bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf;
	if(::IsValid(bpv__Image_0__pf))
	{
		bpfv__CallFunc_GetDynamicMaterial_ReturnValue__pf = bpv__Image_0__pf->UImage::GetDynamicMaterial();
	}
	if(::IsValid(bpfv__CallFunc_GetDynamicMaterial_ReturnValue__pf))
	{
		bpfv__CallFunc_GetDynamicMaterial_ReturnValue__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("Percentage")), bpv__hp__pf);
	}
	return; // KCST_GotoReturn
}
void Umana_C__pf1489439355::bpf__ExecuteUbergraph_mana__pf_2(int32 bpp__EntryPoint__pf)
{
	FTimerHandle bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	bpv__Pawn__pf = b0l__K2Node_CustomEvent_pawn__pf;
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("1")));
	bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimerDelegate(b0l__K2Node_CreateDelegate_OutputDelegate__pf, 0.000000, false, 0.000000, 0.000000);
	return; // KCST_GotoReturn
}
void Umana_C__pf1489439355::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b0l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b0l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_mana__pf_0(9);
}
void Umana_C__pf1489439355::bpf__1__pf()
{
	bpf__ExecuteUbergraph_mana__pf_1(4);
}
void Umana_C__pf1489439355::bpf__initmana__pf(Achesscharacter_C__pf772598429* bpp__pawn__pf)
{
	b0l__K2Node_CustomEvent_pawn__pf = bpp__pawn__pf;
	bpf__ExecuteUbergraph_mana__pf_2(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void Umana_C__pf1489439355::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Umana_C__pf1489439355::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{76, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/SlateCore.Geometry 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Umana_C__pf1489439355
{
	FRegisterHelper__Umana_C__pf1489439355()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/UI/mana"), &Umana_C__pf1489439355::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Umana_C__pf1489439355 Instance;
};
FRegisterHelper__Umana_C__pf1489439355 FRegisterHelper__Umana_C__pf1489439355::Instance;
