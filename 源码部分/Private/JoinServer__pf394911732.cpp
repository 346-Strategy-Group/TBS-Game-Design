...
UJoinServer_C__pf394911732::UJoinServer_C__pf394911732(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Button_42__pf = nullptr;
	bpv__HorizontalBox_0__pf = nullptr;
	bpv__TextBlock_0__pf = nullptr;
	bpv__NameOfServer__pf = FString(TEXT(""));
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UJoinServer_C__pf394911732::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UJoinServer_C__pf394911732::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Button_42"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__JoinServer_Button_42_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__5->LayoutData.Offsets.Right = 685.770935f;
	__Local__5->LayoutData.Offsets.Bottom = 68.733398f;
	...
	auto __Local__6 = NewObject<UHorizontalBox>(__Local__1, TEXT("HorizontalBox_0"), (EObjectFlags)0x00280008);
	...
	auto __Local__8 = NewObject<UHorizontalBoxSlot>(__Local__6, TEXT("HorizontalBoxSlot_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__9 = NewObject<USizeBox>(__Local__1, TEXT("SizeBox_0"), (EObjectFlags)0x00280008);
	__Local__9->WidthOverride = 428.056885f;
	...
	auto __Local__12 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_0"), (EObjectFlags)0x00280008);
	__Local__12->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F4AA3D1F4D5FC17F75E38280A157C0EB]\", \"B0B67EE542A6766768471EB84682D478\", \"\u670d\u52a1\u5668\u540d\")")	);
	__Local__12->Slot = __Local__11;
	__Local__11->Content = __Local__12;
	__Local__10.Add(__Local__11);
	__Local__9->Slot = __Local__8;
	__Local__9->Clipping = EWidgetClipping::ClipToBounds;
	__Local__8->Content = __Local__9;
	__Local__7.Add(__Local__8);
	auto __Local__13 = NewObject<UHorizontalBoxSlot>(__Local__6, TEXT("HorizontalBoxSlot_5"), (EObjectFlags)0x00280008);
	__Local__13->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__13->Parent = __Local__6;
	auto __Local__14 = NewObject<UButton>(__Local__1, TEXT("Button_42"), (EObjectFlags)0x00280008);
	...
	__Local__16->Padding.Top = 0.000000f;
	__Local__16->Padding.Right = 0.000000f;
	__Local__16->Padding.Bottom = 0.000000f;
	__Local__16->Parent = __Local__14;
	auto __Local__17 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_151"), (EObjectFlags)0x00280008);
	__Local__17->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F4AA3D1F4D5FC17F75E38280A157C0EB]\", \"9832FB74405F6D189724388425DD983A\", \"\u52a0\u5165\")")	);
	__Local__17->Slot = __Local__16;
	__Local__17->Clipping = EWidgetClipping::ClipToBounds;
	__Local__16->Content = __Local__17;
	__Local__15.Add(__Local__16);
	__Local__14->Slot = __Local__13;
	__Local__14->Clipping = EWidgetClipping::ClipToBounds;
	__Local__13->Content = __Local__14;
	__Local__7.Add(__Local__13);
...
PRAGMA_ENABLE_OPTIMIZATION
void UJoinServer_C__pf394911732::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__18;
	SlotNames.Append(__Local__18);
}
void UJoinServer_C__pf394911732::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__19;
	TArray<FDelegateRuntimeBinding>  __Local__20;
	__Local__20.AddUninitialized(2);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__20.GetData(), 2);
	auto& __Local__21 = __Local__20[0];
	__Local__21.ObjectName = FString(TEXT("HorizontalBox_0"));
	__Local__21.PropertyName = FName(TEXT("ToolTipText"));
	auto& __Local__22 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__21.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__22 = TArray<FPropertyPathSegment> ();
	__Local__22.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__22.GetData(), 1);
	auto& __Local__23 = __Local__22[0];
	__Local__23.Name = FName(TEXT("NameOfServer"));
	auto& __Local__24 = __Local__20[1];
	__Local__24.ObjectName = FString(TEXT("TextBlock_0"));
	__Local__24.PropertyName = FName(TEXT("Text"));
	auto& __Local__25 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__24.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	...
	__Local__26.Name = FName(TEXT("NameOfServer"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UJoinServer_C__pf394911732::StaticClass())->MiscConvertedSubobjects[0]), __Local__19, __Local__20);
}
void UJoinServer_C__pf394911732::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UJoinServer_C__pf394911732::bpf__ExecuteUbergraph_JoinServer__pf_0(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 3);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	b0l__CallFunc_JoinSession_ReturnValue__pf = UJoinSessionCallbackProxy::JoinSession(this, bpfv__CallFunc_GetPlayerController_ReturnValue__pf, bpv__Server__pf);
	b0l__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_JoinSession_ReturnValue__pf);
	if (!b0l__CallFunc_IsValid_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	b0l__K2Node_CreateDelegate_OutputDelegate_1__pf.BindUFunction(this,FName(TEXT("OnSuccess_1261E3624A1E8650FE67AD874674F30E")));
	if(::IsValid(b0l__CallFunc_JoinSession_ReturnValue__pf))
	{
		b0l__CallFunc_JoinSession_ReturnValue__pf->OnSuccess.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_1__pf);
	}
	b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnFailure_1261E3624A1E8650FE67AD874674F30E")));
	if(::IsValid(b0l__CallFunc_JoinSession_ReturnValue__pf))
	{
		b0l__CallFunc_JoinSession_ReturnValue__pf->OnFailure.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate__pf);
	}
	if(::IsValid(b0l__CallFunc_JoinSession_ReturnValue__pf))
	{
...
void UJoinServer_C__pf394911732::bpf__ExecuteUbergraph_JoinServer__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	return; // KCST_GotoReturn
}
void UJoinServer_C__pf394911732::bpf__ExecuteUbergraph_JoinServer__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void UJoinServer_C__pf394911732::bpf__BndEvt__JoinServer_Button_42_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_JoinServer__pf_0(3);
}
void UJoinServer_C__pf394911732::bpf__OnSuccess_1261E3624A1E8650FE67AD874674F30E__pf()
{
	bpf__ExecuteUbergraph_JoinServer__pf_1(2);
}
void UJoinServer_C__pf394911732::bpf__OnFailure_1261E3624A1E8650FE67AD874674F30E__pf()
{
	bpf__ExecuteUbergraph_JoinServer__pf_2(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void UJoinServer_C__pf394911732::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UJoinServer_C__pf394911732::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{41, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.HorizontalBox 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UJoinServer_C__pf394911732
{
	FRegisterHelper__UJoinServer_C__pf394911732()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Server/JoinServer"), &UJoinServer_C__pf394911732::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UJoinServer_C__pf394911732 Instance;
};
FRegisterHelper__UJoinServer_C__pf394911732 FRegisterHelper__UJoinServer_C__pf394911732::Instance;
