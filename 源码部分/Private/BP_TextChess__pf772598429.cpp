...
ABP_TextChess_C__pf772598429::ABP_TextChess_C__pf772598429(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__SkeletalMesh__pf->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(ABP_TextChess_C__pf772598429::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__SkeletalMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_TextChess_C__pf772598429::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.000000, 0.000000, 70.000000);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(1.750000, 1.750000, 1.750000);
	...
	(((FBoolProperty*)__Local__5)->SetPropertyValue_InContainer((bpv__FloatingPawnMovement__pf), false, 0));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__FloatingPawnMovement__pf), false, 0));
	bpv__health__pf = 0.000000f;
	bpv__healthmax__pf = 0.000000f;
	bpv__mana__pf = 0.000000f;
	bpv__Nowtarget__pf = nullptr;
	AutoPossessAI = EAutoPossessAI::PlacedInWorldOrSpawned;
	AIControllerClass = CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_TextChess_C__pf772598429::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
...
void ABP_TextChess_C__pf772598429::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_TextChess_C__pf772598429::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_TextChess_C__pf772598429::bpf__ExecuteUbergraph_BP_TextChess__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpv__health__pf = bpfv__CallFunc_FMax_ReturnValue__pf;
	// optimized KCST_UnconditionalGoto
...
void ABP_TextChess_C__pf772598429::bpf__ExecuteUbergraph_BP_TextChess__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__SkeletalMesh__pf))
	{
		bpv__SkeletalMesh__pf->USkeletalMeshComponent::PlayAnimation(CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(ABP_TextChess_C__pf772598429::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), false);
	}
	return; // KCST_GotoReturn
}
void ABP_TextChess_C__pf772598429::bpf__ExecuteUbergraph_BP_TextChess__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 5);
	return; // KCST_GotoReturn
}
void ABP_TextChess_C__pf772598429::bpf__ReceiveAnyDamage__pf(float bpp__Damage__pf, const UDamageType* bpp__DamageType__pf__const, AController* bpp__InstigatedBy__pf, AActor* bpp__DamageCauser__pf)
{
	typedef UDamageType*  T__Local__8;
	T__Local__8& bpp__DamageType__pf = *const_cast<T__Local__8 *>(&bpp__DamageType__pf__const);
	...
	bpf__ExecuteUbergraph_BP_TextChess__pf_0(6);
}
void ABP_TextChess_C__pf772598429::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_BP_TextChess__pf_2(5);
}
void ABP_TextChess_C__pf772598429::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_TextChess__pf_1(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_TextChess_C__pf772598429::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_TextChess_C__pf772598429::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_TextChess_C__pf772598429
{
	FRegisterHelper__ABP_TextChess_C__pf772598429()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/AC/BP_TextChess"), &ABP_TextChess_C__pf772598429::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_TextChess_C__pf772598429 Instance;
};
FRegisterHelper__ABP_TextChess_C__pf772598429 FRegisterHelper__ABP_TextChess_C__pf772598429::Instance;
