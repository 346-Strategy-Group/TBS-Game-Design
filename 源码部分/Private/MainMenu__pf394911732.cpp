...
UMainMenu_C__pf394911732::UMainMenu_C__pf394911732(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void UMainMenu_C__pf394911732::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UMainMenu_C__pf394911732::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UFindServer_C__pf394911732::StaticClass());
	...
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__MainMenu_Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("Button_1"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__MainMenu_Button_1_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__MainMenu_Button_0_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__7->LayoutData.Offsets.Left = -755.124512f;
	__Local__7->LayoutData.Offsets.Top = 92.513550f;
	__Local__7->LayoutData.Offsets.Right = 273.506836f;
	__Local__7->LayoutData.Offsets.Bottom = 338.075836f;
	__Local__7->LayoutData.Anchors.Minimum = FVector2D(0.469907, 0.484225);
	__Local__7->LayoutData.Anchors.Maximum = FVector2D(0.469907, 0.484225);
	__Local__7->Parent = __Local__5;
	auto __Local__8 = NewObject<UVerticalBox>(__Local__1, TEXT("VerticalBox_0"), (EObjectFlags)0x00280008);
	...
	auto __Local__10 = NewObject<UVerticalBoxSlot>(__Local__8, TEXT("VerticalBoxSlot_2"), (EObjectFlags)0x00280008);
	__Local__10->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__10->Padding.Bottom = 55.000000f;
	__Local__10->Parent = __Local__8;
	auto __Local__11 = NewObject<UButton>(__Local__1, TEXT("Button"), (EObjectFlags)0x00280008);
	...
	auto __Local__13 = NewObject<UButtonSlot>(__Local__11, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__13->Padding.Left = 0.000000f;
	__Local__13->Padding.Top = 0.000000f;
	__Local__13->Padding.Right = 0.000000f;
	__Local__13->Padding.Bottom = 0.000000f;
	__Local__13->Parent = __Local__11;
	auto __Local__14 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock"), (EObjectFlags)0x00280008);
	__Local__14->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[88C2E9DB45CE6549E17598808B19A243]\", \"2B90CCFA450DFFF03CF7DE8D5A96B8E8\", \"\u5f00\u623f\")")	);
	...
	auto __Local__15 = NewObject<UVerticalBoxSlot>(__Local__8, TEXT("VerticalBoxSlot_4"), (EObjectFlags)0x00280008);
	__Local__15->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__15->Padding.Bottom = 55.000000f;
	__Local__15->Parent = __Local__8;
	auto __Local__16 = NewObject<UButton>(__Local__1, TEXT("Button_0"), (EObjectFlags)0x00280008);
	...
	auto __Local__18 = NewObject<UButtonSlot>(__Local__16, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__18->Parent = __Local__16;
	auto __Local__19 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_0"), (EObjectFlags)0x00280008);
	__Local__19->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[88C2E9DB45CE6549E17598808B19A243]\", \"3E7CD5964DCCCC2B9AABB7AE7E043937\", \"\u67e5\u623f\")")	);
	...
	auto __Local__20 = NewObject<UVerticalBoxSlot>(__Local__8, TEXT("VerticalBoxSlot_3"), (EObjectFlags)0x00280008);
	__Local__20->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__20->Parent = __Local__8;
	auto __Local__21 = NewObject<UButton>(__Local__1, TEXT("Button_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__23 = NewObject<UButtonSlot>(__Local__21, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__23->Parent = __Local__21;
	auto __Local__24 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_1"), (EObjectFlags)0x00280008);
	__Local__24->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[88C2E9DB45CE6549E17598808B19A243]\", \"7C199A3C481FA7CFE6A09C949CAB7469\", \"\u9000\u623f\")")	);
...
PRAGMA_ENABLE_OPTIMIZATION
void UMainMenu_C__pf394911732::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__25;
	SlotNames.Append(__Local__25);
}
void UMainMenu_C__pf394911732::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__26;
	TArray<FDelegateRuntimeBinding>  __Local__27;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UMainMenu_C__pf394911732::StaticClass())->MiscConvertedSubobjects[0]), __Local__26, __Local__27);
}
void UMainMenu_C__pf394911732::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UMainMenu_C__pf394911732::bpf__ExecuteUbergraph_MainMenu__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				UGameplayStatics::OpenLevel(this, FName(TEXT("NewMap")), true, FString(TEXT("listen")));
				__CurrentState = -1;
				break;
			}
		case 10:
			{
				...
				b0l__CallFunc_CreateSession_ReturnValue__pf = UCreateSessionCallbackProxy::CreateSession(this, bpfv__CallFunc_GetPlayerController_ReturnValue__pf, 1000, false);
			}
		case 11:
			{
		...
		case 12:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_1__pf.BindUFunction(this,FName(TEXT("OnSuccess_5135A5EE4738221613BFCF8D37A0EF4C")));
				if(::IsValid(b0l__CallFunc_CreateSession_ReturnValue__pf))
				{
					b0l__CallFunc_CreateSession_ReturnValue__pf->OnSuccess.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_1__pf);
				}
			}
		case 13:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnFailure_5135A5EE4738221613BFCF8D37A0EF4C")));
				if(::IsValid(b0l__CallFunc_CreateSession_ReturnValue__pf))
				{
					b0l__CallFunc_CreateSession_ReturnValue__pf->OnFailure.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate__pf);
				}
			}
		case 14:
			{
...
void UMainMenu_C__pf394911732::bpf__ExecuteUbergraph_MainMenu__pf_1(int32 bpp__EntryPoint__pf)
{
	UFindServer_C__pf394911732* bpfv__CallFunc_Create_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 4);
	// optimized KCST_UnconditionalGoto
	UWidgetLayoutLibrary::RemoveAllWidgets(this);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UFindServer_C__pf394911732>(UWidgetBlueprintLibrary::Create(this, UFindServer_C__pf394911732::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
...
void UMainMenu_C__pf394911732::bpf__ExecuteUbergraph_MainMenu__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UMainMenu_C__pf394911732::bpf__ExecuteUbergraph_MainMenu__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void UMainMenu_C__pf394911732::bpf__BndEvt__MainMenu_Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu__pf_0(15);
}
void UMainMenu_C__pf394911732::bpf__BndEvt__MainMenu_Button_1_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu__pf_2(8);
}
void UMainMenu_C__pf394911732::bpf__BndEvt__MainMenu_Button_0_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu__pf_1(4);
}
void UMainMenu_C__pf394911732::bpf__OnSuccess_5135A5EE4738221613BFCF8D37A0EF4C__pf()
{
	bpf__ExecuteUbergraph_MainMenu__pf_0(2);
}
void UMainMenu_C__pf394911732::bpf__OnFailure_5135A5EE4738221613BFCF8D37A0EF4C__pf()
{
	bpf__ExecuteUbergraph_MainMenu__pf_3(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void UMainMenu_C__pf394911732::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UMainMenu_C__pf394911732::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{37, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/OnlineSubsystemUtils.BlueprintSessionResult 
		...
		{48, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.ScrollBox 
		...
		{52, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.CircularThrobber 
		...
		{56, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Server/FindServer.FindServer_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UMainMenu_C__pf394911732
{
	FRegisterHelper__UMainMenu_C__pf394911732()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Server/MainMenu"), &UMainMenu_C__pf394911732::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UMainMenu_C__pf394911732 Instance;
};
FRegisterHelper__UMainMenu_C__pf394911732 FRegisterHelper__UMainMenu_C__pf394911732::Instance;
