...
USpinBox_Vector2D_C__pf530537768::USpinBox_Vector2D_C__pf530537768(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
TEXT("NSLOCTEXT(\"[9AA6812D440E5E4B400EDAABF1FA3CFD]\", \"77DA6E0945102A1526A82CA244BE4578\", \"Spin Box:\")")	);
	bpv__MinMax_Slider__pf = FVector2D(0.000000, 10.000000);
	bpv__MinMax_Value__pf = FVector2D(0.000000, 10.000000);
	bpv__Value__pf = FVector2D(0.000000, 0.000000);
...
void USpinBox_Vector2D_C__pf530537768::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USpinBox_Vector2D_C__pf530537768::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("SpinBox_Value_Y"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnValueChanged"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__SpinBox_Vector2D_SpinBox_Value_Y_K2Node_ComponentBoundEvent_1_OnSpinBoxValueChangedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("SpinBox_Value_X"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnValueChanged"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__SpinBox_Carema_SpinBox_Value_K2Node_ComponentBoundEvent_0_OnSpinBoxValueChangedEvent__DelegateSignature"));
	auto __Local__4 = NewObject<UHorizontalBox>(__Local__1, TEXT("HorizontalBox_22"), (EObjectFlags)0x00280008);
	...
	__Local__6->Padding.Left = 5.000000f;
	__Local__6->Padding.Top = 5.000000f;
	__Local__6->Padding.Right = 5.000000f;
	__Local__6->Padding.Bottom = 5.000000f;
	__Local__6->VerticalAlignment = EVerticalAlignment::VAlign_Center;
	__Local__6->Parent = __Local__4;
	auto __Local__7 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_Value"), (EObjectFlags)0x00280008);
	__Local__7->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"UMG\", \"TextBlockDefaultValue\", \"Text Block\")")	);
	__Local__7->Font.TypefaceFontName = FName(TEXT("Light"));
	__Local__7->Font.Size = 10;
	__Local__7->Slot = __Local__6;
	__Local__7->bIsVariable = true;
	__Local__6->Content = __Local__7;
	__Local__5.Add(__Local__6);
	auto __Local__8 = NewObject<UHorizontalBoxSlot>(__Local__4, TEXT("HorizontalBoxSlot_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__9 = NewObject<UBorder>(__Local__1, TEXT("Border_0"), (EObjectFlags)0x00280008);
	__Local__9->BrushColor = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	...
	auto __Local__12 = NewObject<USpinBox>(__Local__1, TEXT("SpinBox_Value_X"), (EObjectFlags)0x00280008);
	__Local__12->Value = 5.000000f;
	auto& __Local__13 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__12->WidgetStyle.BackgroundBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__13 = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__14 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__12->WidgetStyle.HoveredBackgroundBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__14 = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__15 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__12->WidgetStyle.ActiveFillBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__15 = FLinearColor(0.029557, 0.029557, 0.029557, 1.000000);
	auto& __Local__16 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__12->WidgetStyle.InactiveFillBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__16 = FLinearColor(0.029557, 0.029557, 0.029557, 1.000000);
	__Local__12->Font.TypefaceFontName = FName(TEXT("Light"));
	__Local__12->Font.Size = 10;
	auto& __Local__17 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__12->ForegroundColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__17 = FLinearColor(1.000000, 1.000000, 1.000000, 1.000000);
	static TWeakFieldPtr<FProperty> __Local__19{};
	const FProperty* __Local__18 = __Local__19.Get();
	if (nullptr == __Local__18)
	{
		__Local__18 = (USpinBox::StaticClass())->FindPropertyByName(FName(TEXT("bOverride_MinSliderValue")));
		check(__Local__18);
		__Local__19 = __Local__18;
	}
	(((FBoolProperty*)__Local__18)->SetPropertyValue_InContainer((__Local__12), true, 0));
	static TWeakFieldPtr<FProperty> __Local__21{};
	const FProperty* __Local__20 = __Local__21.Get();
	if (nullptr == __Local__20)
	{
		__Local__20 = (USpinBox::StaticClass())->FindPropertyByName(FName(TEXT("bOverride_MaxSliderValue")));
		check(__Local__20);
		__Local__21 = __Local__20;
	}
	(((FBoolProperty*)__Local__20)->SetPropertyValue_InContainer((__Local__12), true, 0));
	auto& __Local__22 = (*(AccessPrivateProperty<float >((__Local__12), USpinBox::__PPO__MaxSliderValue() )));
	__Local__22 = 10.000000f;
	...
	auto __Local__23 = NewObject<UHorizontalBoxSlot>(__Local__4, TEXT("HorizontalBoxSlot_2"), (EObjectFlags)0x00280008);
	...
	auto __Local__24 = NewObject<UBorder>(__Local__1, TEXT("Border"), (EObjectFlags)0x00280008);
	...
	auto __Local__27 = NewObject<USpinBox>(__Local__1, TEXT("SpinBox_Value_Y"), (EObjectFlags)0x00280008);
	__Local__27->Value = 5.000000f;
	auto& __Local__28 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__27->WidgetStyle.BackgroundBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__28 = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__29 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__27->WidgetStyle.HoveredBackgroundBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__29 = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__30 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__27->WidgetStyle.ActiveFillBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__30 = FLinearColor(0.029557, 0.029557, 0.029557, 1.000000);
	auto& __Local__31 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__27->WidgetStyle.InactiveFillBrush.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__31 = FLinearColor(0.029557, 0.029557, 0.029557, 1.000000);
	__Local__27->Font.TypefaceFontName = FName(TEXT("Light"));
	__Local__27->Font.Size = 10;
	auto& __Local__32 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__27->ForegroundColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__32 = FLinearColor(1.000000, 1.000000, 1.000000, 1.000000);
	(((FBoolProperty*)__Local__18)->SetPropertyValue_InContainer((__Local__27), true, 0));
	(((FBoolProperty*)__Local__20)->SetPropertyValue_InContainer((__Local__27), true, 0));
	auto& __Local__33 = (*(AccessPrivateProperty<float >((__Local__27), USpinBox::__PPO__MaxSliderValue() )));
	__Local__33 = 10.000000f;
...
PRAGMA_ENABLE_OPTIMIZATION
void USpinBox_Vector2D_C__pf530537768::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__34;
	SlotNames.Append(__Local__34);
}
void USpinBox_Vector2D_C__pf530537768::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__35;
	TArray<FDelegateRuntimeBinding>  __Local__36;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(USpinBox_Vector2D_C__pf530537768::StaticClass())->MiscConvertedSubobjects[0]), __Local__35, __Local__36);
}
void USpinBox_Vector2D_C__pf530537768::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void USpinBox_Vector2D_C__pf530537768::bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_0(int32 bpp__EntryPoint__pf)
{
...
void USpinBox_Vector2D_C__pf530537768::bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 17:
			{
				...
				bpfv__CallFunc_MakeVector2D_ReturnValue__pf = UKismetMathLibrary::MakeVector2D(bpfv__CallFunc_GetValue_ReturnValue__pf, bpfv__CallFunc_GetValue_ReturnValue_1__pf);
				bpv__Value__pf = bpfv__CallFunc_MakeVector2D_ReturnValue__pf;
				__CurrentState = 14;
				break;
			}
		case 35:
		...
		case 37:
			{
				UKismetSystemLibrary::Delay(this, 0.050000, FLatentActionInfo(1, 501768960, TEXT("ExecuteUbergraph_SpinBox_Vector2D_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 38:
...
void USpinBox_Vector2D_C__pf530537768::bpf__BndEvt__SpinBox_Vector2D_SpinBox_Value_Y_K2Node_ComponentBoundEvent_1_OnSpinBoxValueChangedEvent__DelegateSignature__pf(float bpp__InValue__pf)
{
	b0l__K2Node_ComponentBoundEvent_InValue__pf = bpp__InValue__pf;
	bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_1(38);
}
void USpinBox_Vector2D_C__pf530537768::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_1(36);
}
void USpinBox_Vector2D_C__pf530537768::bpf__BndEvt__SpinBox_Carema_SpinBox_Value_K2Node_ComponentBoundEvent_0_OnSpinBoxValueChangedEvent__DelegateSignature__pf(float bpp__InValue__pf)
{
	b0l__K2Node_ComponentBoundEvent_InValue_1__pf = bpp__InValue__pf;
	bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_1(35);
}
void USpinBox_Vector2D_C__pf530537768::bpf__PreConstruct__pf(bool bpp__IsDesignTime__pf)
{
	b0l__K2Node_Event_IsDesignTime__pf = bpp__IsDesignTime__pf;
	bpf__ExecuteUbergraph_SpinBox_Vector2D__pf_0(33);
}
void USpinBox_Vector2D_C__pf530537768::bpf__Set_Value__pf(FVector2D bpp__NewValue__pf)
{
	float bpfv__CallFunc_BreakVector2D_X__pf{};
	float bpfv__CallFunc_BreakVector2D_Y__pf{};
	bpv__Value__pf = bpp__NewValue__pf;
	UKismetMathLibrary::BreakVector2D(bpv__Value__pf, /*out*/ bpfv__CallFunc_BreakVector2D_X__pf, /*out*/ bpfv__CallFunc_BreakVector2D_Y__pf);
	if(::IsValid(bpv__SpinBox_Value_X__pf))
	{
		bpv__SpinBox_Value_X__pf->USpinBox::SetValue(bpfv__CallFunc_BreakVector2D_X__pf);
	}
	UKismetMathLibrary::BreakVector2D(bpv__Value__pf, /*out*/ bpfv__CallFunc_BreakVector2D_X__pf, /*out*/ bpfv__CallFunc_BreakVector2D_Y__pf);
	if(::IsValid(bpv__SpinBox_Value_Y__pf))
	{
		bpv__SpinBox_Value_Y__pf->USpinBox::SetValue(bpfv__CallFunc_BreakVector2D_Y__pf);
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void USpinBox_Vector2D_C__pf530537768::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USpinBox_Vector2D_C__pf530537768::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USpinBox_Vector2D_C__pf530537768
{
	FRegisterHelper__USpinBox_Vector2D_C__pf530537768()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/DebugMenu/Widgets/SpinBox_Vector2D"), &USpinBox_Vector2D_C__pf530537768::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USpinBox_Vector2D_C__pf530537768 Instance;
};
FRegisterHelper__USpinBox_Vector2D_C__pf530537768 FRegisterHelper__USpinBox_Vector2D_C__pf530537768::Instance;
